...
api: 'POST https://development.chatsappai.com/api/datastores/update/{datastoreId}'
...
curl --location --request POST 'https://development.chatsappai.com/api/datastores/update/<datastoreId>' \
