...
api: 'POST https://development.chatsappai.com/api/datastores/file-upload/generate-link/{datastoreId}'
...
```js
const apiUrl = 'https://development.chatsappai.com/api';
const apiKey = 'XXX';
...
curl --location --request POST 'https://development.chatsappai.com/api/datastores/file-upload/generate-link/<datastoreId>' \
