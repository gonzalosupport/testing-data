...
api: 'POST https://development.chatsappai.com/api/datastores/upsert/{datastoreId}'
...
curl --location --request POST 'https://development.chatsappai.com/api/datastores/upsert/<datastoreId>' \
