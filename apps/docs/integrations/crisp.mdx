ChatsappAI’s Crisp plugin allows you to automate your customer support volume by connecting a ChatsappAIAgent to your Crisp account.

## Features

### Answer Questions

The Agent can answer questions related to product information or to any other data provided to the Agent via the ChatsappAIdashboard.
