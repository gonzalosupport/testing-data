          ...
          <div className="flex-auto w-screen max-w-md overflow-hidden text-sm leading-6 bg-white shadow-lg rounded-3xl ring-1 ring-gray-900/5">
            <div className="p-4">
              {solutions.map((item) => (
                <div
                  key={item.name}
                  className="relative flex p-4 rounded-lg gap-x-6 group hover:bg-gray-50"
                >
                  <div className="flex items-center justify-center flex-none mt-1 rounded-lg w-11 h-11 bg-gray-50 group-hover:bg-white">
                    <item.icon
            ...
            <div className="grid grid-cols-2 divide-x bg-gray-50 divide-gray-900/5">
